      ...
      { type: 'table',
        ...
        rows: [
          ...
          [ { fr: 'Il nomme l’écran, la souris et le clavier.', en: 'Names the screen, the mouse and the keyboard.' },
            ...
            { fr: 'Il tape un mot court et compte des objets jusqu’à 8.', en: 'Types a short word and counts objects up to 8.' } ],
  ...
  { id: 'roles', emoji: '👥', title: { fr: 'Gérer 25 enfants avec un seul écran', en: 'Managing 25 children with one screen' },
    blocks: [
      ...
      { type: 'ul', items: [
        ...
        { fr: 'Ateliers tournants de 10 min : TBI avec vous · fiche ch8 avec l’ATSEM · dessin à la table.', en: 'Rotating stations of 10 min: whiteboard with you · ch8 sheet with the assistant · drawing at the table.' },
  ...
  { id: 'setup', emoji: '🖥️', title: { fr: 'Installation et matériel', en: 'Set-up and materials' },
    blocks: [
      { type: 'ul', items: [
        ...
        { fr: 'Voix française à installer une fois. Paramètres Windows › Heure et langue › Voix › Ajouter des voix › Français, puis rouvrir le site.', en: 'Install the voice once. Windows Settings › Time & language › Speech › Add voices › French, then reopen the site.' },
        ...
        { fr: 'Le mode prof 👩‍🏫 de l’en-tête ouvre 📖 Guide et le « Coin du prof » de chaque activité.', en: 'Teacher mode 👩‍🏫 in the header opens 📖 Guide and each activity’s “Teacher corner”.' },
        { fr: 'Les cartes flèches et les cartes du robot s’impriment depuis cette page : bouton 🖨️ tout en bas.', en: 'The arrow cards and the robot cards print from this page: the 🖨️ button at the very bottom.' },
      ] },
      { type: 'table',
        head: [ { fr: 'À fabriquer une fois', en: 'Make once' }, { fr: 'Détail', en: 'Details' }, { fr: 'Sert pour', en: 'Used in' } ],
        rows: [
          [ { fr: 'Cartes flèches A5 ⬆️ ⬇️ ⬅️ ➡️', en: 'A5 arrow cards ⬆️ ⬇️ ⬅️ ➡️' }, { fr: 'Mêmes glyphes que le jeu du chien : à imprimer ici (🖨️), 4 de chaque, plastifiées.', en: 'Same glyphs as the dog game: print here (🖨️), 4 of each, laminated.' }, { fr: 'ch8-s1:a, ch8-s1:b, ch5-s5:d', en: 'ch8-s1:a, ch8-s1:b, ch5-s5:d' } ],
          [ { fr: 'Cartes mTiny ↑ ↓ ↰ ↱', en: 'mTiny cards ↑ ↓ ↰ ↱' }, { fr: 'À imprimer ici (🖨️). Bord coloré comme à l’écran : ↑ vert #10b981, ↓ turquoise #14b8a6, ↰ indigo #6366f1, ↱ violet #8b5cf6.', en: 'Print here (🖨️). Coloured border as on screen: ↑ green #10b981, ↓ teal #14b8a6, ↰ indigo #6366f1, ↱ purple #8b5cf6.' }, { fr: 'ch7-s1:h, ch8-s1:tot', en: 'ch7-s1:h, ch8-s1:tot' } ],
    ...
    blocks: [
      { type: 'table',
        ...
        rows: [
          ...
          [ { fr: 'Remettre la progression à zéro', en: 'Reset the progress' }, { fr: 'Dans le chapitre, près du compteur (ex. 3/12), touchez « ↺ remettre ce chapitre à zéro », puis confirmez.', en: 'In the chapter, next to the counter (e.g. 3/12), touch “↺ reset this chapter”, then confirm.' } ],
